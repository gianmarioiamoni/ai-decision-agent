...
# 
# Problem: Existing records have decision_id=0 instead of actual IDs
# Solution: Match questions from SQLite DB with Chroma embeddings and update metadata
#
# Usage: python3 scripts/maintenance/fix_chroma_decision_ids.py
...
CHROMA_DB_PATH = PROJECT_ROOT / "chroma_memory" / "chroma.sqlite3"
MEMORY_DB_PATH = PROJECT_ROOT / "long_term_memory.db"
